var govmap = {
    ...
    getRestServiceRoot: function () {
        if (this.urlWithProtocol.indexOf("localhost") != -1)
            return this.getProtocol() + "localhost/AngularJS.Govmap.REST";
        return this.getProtocol() + "ags.govmap.gov.il";
    },
...
govmap.protocol = 'https://';
govmap.mapUrl = 'new.govmap.gov.il';//govmap.getScriptHostUrl();
